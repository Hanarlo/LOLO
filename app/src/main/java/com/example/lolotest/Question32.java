...
public class Question32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton FourthAnswerButton = findViewById(R.id.fourthAnswer);
        FourthAnswerButton.setOnClickListener(radioButtonClickListener);
        FOA = FourthAnswerButton.getText().toString();

        RadioButton FiveAnswerButton = findViewById(R.id.FivthAnswer);
        FiveAnswerButton.setOnClickListener(radioButtonClickListener);
        FIVEA = FiveAnswerButton.getText().toString();
    }
        ...
        public void onClick(View v) {
            ...
            switch (rb.getId()) {
                ...
                case R.id.thirdAnswer: YourAnswer = TA;
                    ...
                    break;
                case R.id.fourthAnswer: YourAnswer = FOA;


                    break;
                case R.id.FivthAnswer: YourAnswer = FIVEA;
                    AnswerIsCorrect++;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.cancel_button:
                ...
                //cdd.getWindow();
                //cdd.show();
                AlertDialog.Builder builder = new AlertDialog.Builder(Question32.this);

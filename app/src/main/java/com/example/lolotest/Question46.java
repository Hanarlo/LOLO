...
public class Question46 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question46);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.cancel_button:
                ...
                //cdd.getWindow();
                //cdd.show();
                AlertDialog.Builder builder = new AlertDialog.Builder(Question46.this);
